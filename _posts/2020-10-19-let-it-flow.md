...
![image-left]({{ site.url }}{{ site.baseurl }}/assets/images/important.jpg){: .align-right} Once you've created your workbench app, make sure you share it with the people you want to use it (most likely your publishers/editors).